...
- **Servidores (Servers): ** Nós que tem serviços que acionam funções e nós 
- **Cliente (client): ** Nós que pedem para os serviços funcionarem
...
### Passo 1: Copiar o Código (crtl-C)
